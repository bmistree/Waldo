...
class Ping():
    ...
    def _sendMsg (self,msg,funcNameFrom):
        ...
        self.connectionObject.writeMsg(msgToSend);
    ...
    def _msgReceive(self,msg):
        ...
        dispatchSrcStr = 'self.% (' % msg['dispatchTo'];
    ...
    def _msgSendOne(self):
        ...
        if (self.whichEnv == INTERMEDIATE_CONTEXT):
            ...
            msg = {};
            msg['responses'] = self.intermedate.responses;
    ...
    def _msgRecvThree(self,receivedMsg):
        '''
        NOT EXACT
        '''
