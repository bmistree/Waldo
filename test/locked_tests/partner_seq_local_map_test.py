...
from waldo.lib.waldoLockedVariables import SingleThreadedLockedMapVariable
...
'''
Create a sequence local map, send message to other endpoint.  Other
endpoint adds data to map, and we test that we get the modification
back.
'''
KEY_A = 'key_a'
VAL_A = 32
