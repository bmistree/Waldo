...
def run_test():
    ...
    accept_stoppable = Waldo.stcp_accept(
        ...
        SideA, SIDEA_HOST, SIDEA_PORT,"security_tests/cert.pem", "security_tests/privatekey.pem",None,original_sidea_num,
        connected_callback=sidea_connected)
    
    sideb = Waldo.stcp_connect(
        SideB,SIDEA_HOST,SIDEA_PORT,"security_tests/cert.pem", "security_tests/privatekey.pem",original_sideb_num)
