    ...
    class _SideA (_waldo_classes["Endpoint"]):
        ...
        def _endpoint_func_call_prefix__waldo__test_seq_arg(self,_active_event,_context,amt_to_increment,_returning_to_public_ext_array=None):
            ...
            if _returning_to_public_ext_array != None:
                ...
                return _context.flatten_into_single_return_tuple((self._partner_endpoint_msg_func_call_prefix__waldo__start_arguments_check_exchange(_active_event,_context,_context.global_store.get_var_if_exists("0__num"),amt_to_increment,) if _context.set_msg_send_initialized_bit_false() else None) if 0 in _returning_to_public_ext_array else _context.de_waldoify((self._partner_endpoint_msg_func_call_prefix__waldo__start_arguments_check_exchange(_active_event,_context,_context.global_store.get_var_if_exists("0__num"),amt_to_increment,) if _context.set_msg_send_initialized_bit_false() else None),_active_event),_context.global_store.get_var_if_exists("0__num") if 1 in _returning_to_public_ext_array else _context.de_waldoify(_context.global_store.get_var_if_exists("0__num"),_active_event))
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__start_arguments_check_exchange(self,_active_event,_context,some_number=None,amt_to_increment=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "8__some_number", _context.convert_for_seq_local(some_number,_active_event,self._host_uuid)
                    )

                    _context.sequence_local_store.add_var(
                        "9__amt_to_increment", _context.convert_for_seq_local(amt_to_increment,_active_event,self._host_uuid)
                    )
                ...
                _context.sequence_local_store.add_var(
                    "10__to_return",_context.convert_for_seq_local(to_return,_active_event,self._host_uuid))

                pass

            _tmp0 = (_context.get_val_if_waldo(_context.sequence_local_store.get_var_if_exists("8__some_number"),_active_event) + _context.get_val_if_waldo(_context.sequence_local_store.get_var_if_exists("9__amt_to_increment"),_active_event))
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("8__some_number"),_tmp0,_active_event):
                pass
            ...
            return _context.sequence_local_store.get_var_if_exists("10__to_return")
...
def SideB (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _SideB (_waldo_classes["Endpoint"]):
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__receive_arguments_check_exchange(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _tmp0 = _context.sequence_local_store.get_var_if_exists("8__some_number")
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("10__to_return"),_tmp0,_active_event):
                pass
