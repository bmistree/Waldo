    ...
    class _SideA (_waldo_classes["Endpoint"]):
        ...
        def _endpoint_func_call_prefix__waldo__get_other_val(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            if _returning_to_public_ext_array != None:
                ...
                return _context.flatten_into_single_return_tuple((self._partner_endpoint_msg_func_call_prefix__waldo__start_get(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None) if 0 in _returning_to_public_ext_array else _context.de_waldoify((self._partner_endpoint_msg_func_call_prefix__waldo__start_get(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None),_active_event))


            # otherwise, use regular return mechanism... do not de-waldo-ify
            return _context.flatten_into_single_return_tuple((self._partner_endpoint_msg_func_call_prefix__waldo__start_get(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None))
        ...
        def _endpoint_func_call_prefix__waldo__set_other_val(self,_active_event,_context,new_val,_returning_to_public_ext_array=None):
            ...
            (self._partner_endpoint_msg_func_call_prefix__waldo__start_set(_active_event,_context,new_val,) if _context.set_msg_send_initialized_bit_false() else None)

        ### USER DEFINED SEQUENCE BLOCKS ###

        ### User-defined message send blocks ###

        def _partner_endpoint_msg_func_call_prefix__waldo__start_get(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                other_num = self._waldo_classes["WaldoNumVariable"](  # the type of waldo variable to create
                    '13__other_num', # variable's name
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__start_set(self,_active_event,_context,to_set_to=None,_returning_to_public_ext_array=None):
