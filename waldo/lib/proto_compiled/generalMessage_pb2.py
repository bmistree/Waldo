...
_GENERALMESSAGE_MESSAGETYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='PARTNER_ERROR', index=11, number=11,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='HEARTBEAT', index=12, number=12,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='PROMOTION', index=13, number=13,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TIMESTAMP_UPDATE', index=14, number=14,
      options=None,
      type=None),
  ],
...
_GENERALMESSAGE = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='error', full_name='GeneralMessage.error', index=12,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='heartbeat', full_name='GeneralMessage.heartbeat', index=13,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='promotion', full_name='GeneralMessage.promotion', index=14,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='timestamp_updated', full_name='GeneralMessage.timestamp_updated', index=15,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='timestamp', full_name='GeneralMessage.timestamp', index=16,
...
_GENERALMESSAGE.fields_by_name['error'].message_type = partnerError_pb2._PARTNERERROR
_GENERALMESSAGE.fields_by_name['heartbeat'].message_type = heartbeat_pb2._HEARTBEAT
_GENERALMESSAGE.fields_by_name['promotion'].message_type = promotionMessage_pb2._PROMOTION
_GENERALMESSAGE.fields_by_name['timestamp_updated'].message_type = util_pb2._TIMESTAMP
