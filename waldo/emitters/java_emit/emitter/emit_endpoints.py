...
def emit_endpoint_body(
    ...
    '''
    # emit constructor
    endpoint_body_text = emit_endpoint_constructor(
        endpoint_name,ast_root,fdep_dict,emit_ctx)
    endpoint_body_text += '\n\n'
...
def emit_endpoint_global_and_peered_variable_store(
    ...
    contained in _global_variable_store.  
    '''
    ...
    var_store_loading_text = 'waldo.LockedActiveEvent _active_event = null;'
