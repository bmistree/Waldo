...
public class SameHostConnection implements Runnable, ConnectionObj {
	...
	private class SameHostQueueElement
	{
		...
		public SameHostQueueElement(GeneralMessage msg_to_write, waldo.Endpoint _endpoint)
		{
	...
	ArrayBlockingQueue<SameHostQueueElement> queue = new ArrayBlockingQueue<SameHostQueueElement>(Util.QUEUE_CAPACITIES);
	...
	@Override
	public void write_stop(GeneralMessage msg_to_write,
			waldo.Endpoint endpoint_writing)
	{
