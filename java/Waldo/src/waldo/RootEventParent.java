...
public class RootEventParent extends EventParent {
	 ...
	 * 	# indices are event uuids.  Values are bools.  When all values
    	...
    	# phase commit.
	 */
	private HashMap<String,Boolean> endpoints_waiting_on_commit = new HashMap<String,Boolean>();
	...
	*/
    ...
    # of the second.
	*/
    private java.util.concurrent.locks.ReentrantLock _endpoints_waiting_on_commit_lock = 
    ...
    */
	public RootEventParent(Endpoint _local_endpoint,String _uuid, String _priority)
	{
            ...
            boolean partner_contacted, LockedActiveEvent _event)
    {
        ...
        super.first_phase_transition_success(same_host_endpoints_contacted_dict, partner_contacted, _event);
	...
	*/
    ...
    {
        _lock_endpoints_waiting_on_commit();
        for (Boolean endpoint_transitioned : endpoints_waiting_on_commit.values())
        {
