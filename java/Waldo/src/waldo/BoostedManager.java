...
public class BoostedManager {
	...
	*/
	private ArrayList<LockedActiveEvent> event_list = new ArrayList<LockedActiveEvent>();
	...
	/**
        ...
        @returns {null/LockedActiveEvent} --- If retry is True, we return a new
        event with successor uuid.  Otherwise, return null.
        '''
	 */
	public LockedActiveEvent complete_root_event(String completed_event_uuid, boolean retry)
	{
		int counter = 0;
