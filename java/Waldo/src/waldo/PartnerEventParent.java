...
public class PartnerEventParent extends EventParent {
	...
	public PartnerEventParent(Endpoint _local_endpoint, String _uuid , String _priority)
	{
            ...
            boolean partner_contacted, LockedActiveEvent _event)
	{
		...
		super.first_phase_transition_success(same_host_endpoints_contacted_dict,
		...
		ArrayList<String> children_endpoints = new ArrayList<String>(same_host_endpoints_contacted_dict.keySet());
