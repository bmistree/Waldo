...
public class VariableStore 
{
			...
			LockedActiveEvent active_event,boolean force, VarStoreDeltas.Builder all_deltas)
	{
		...
		for (Entry<String, LockedObject> entry : name_to_var_map.entrySet())
		{
			...
			if (waldo_variable.is_peered())
				waldo_variable.serializable_var_tuple_for_network(all_deltas,entry.getKey(),active_event,force);
		}
		return all_deltas;
	}
	 ...
	 */
	public void incorporate_deltas(LockedActiveEvent active_event, VarStoreDeltas var_store_deltas)
	{
