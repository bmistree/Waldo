...
public class Waldo {
	...
	public static Endpoint tcp_connect(
			EndpointConstructorObj constructor_obj, String host, int port) throws IOException
	{
			...
			SignalFunction connected_callback)
	{
		...
		//# before returning.
		ArrayBlockingQueue<Boolean> synchronization_listening_queue = new ArrayBlockingQueue<Boolean>(Util.SMALL_QUEUE_CAPACITIES);
