...
public class ReceivePromotionAction extends ServiceAction {
	...
	public ReceivePromotionAction(waldo.Endpoint _local_endpoint, String _event_uuid, String _new_priority)
	{
	...
	public void run() 
	{
		LockedActiveEvent evt = local_endpoint._act_event_map.get_event(event_uuid);
		if (evt != null)
