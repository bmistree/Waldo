...
public class ReceiveRequestCommitAction extends ServiceAction 
{
	...
	public ReceiveRequestCommitAction(waldo.Endpoint _local_endpoint, String _event_uuid, boolean _from_partner)
	{
	...
	public void run() 
	{
		waldo.LockedActiveEvent evt = local_endpoint._act_event_map.get_event(event_uuid);
