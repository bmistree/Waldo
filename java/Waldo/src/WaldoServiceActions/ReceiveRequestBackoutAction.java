...
public class ReceiveRequestBackoutAction extends ServiceAction{
	...
	private waldo.Endpoint requesting_endpoint = null;
	 ...
	 */
	public ReceiveRequestBackoutAction(waldo.Endpoint _endpoint, String _uuid,
			waldo.Endpoint _requesting_endpoint) 
	{
